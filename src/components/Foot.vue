  ...
  <div class="foot">
    <el-row class="foot-text">
      ...
      <el-col :span="6">
        ...
        <div class="colume-content"><a href="https://github.com/nlh1996/gameWeb"
             target="_blank">git地址</a></div>
      </el-col>
    </el-row>
    ...
    <el-row class="foot-img">
      <el-col>
        <a target="_blank"
           rel="nofollow"
           href="http://www.zx110.org/picp/?sn=310104100043687">备案号：310104100043687</a>
        <a target="_blank"
           rel="nofollow"
           href="http://www.zx110.org/picp/?sn=310104100043687">备案号：310104100043687</a>
        <a rel="nofollow"
           href="http://www.miibeian.gov.cn/"
           target="_blank">沪ICP备09058784号</a>
        <a href="//pic.youzu.com/youzu/images/layout/net.jpg"
           target="_blank">沪网文[2015]0819-219</a>
        <a href="http://pic.youzu.com/youzu/images/layout/publish.jpg"
           rel="nofollow"
      ...
      <el-col>
        <ul>
          <li v-for="item in images"
              :key="item.url">
            <router-link to="/guardian"><img :src="item.url"></router-link>
          </li>
        </ul>
      </el-col>
    </el-row>
